        ...
        <div class="row">
            <div class="col-md-12 tw-mb-3">
                <h4 class="tw-my-0 tw-font-bold tw-text-xl">
                    <?php echo _l($lang_prefix.'states'); ?>
                </h4>
            </div>
            <div class="col-md-12">
                <div class="_buttons tw-mb-2">
                    <?php if ($has_permission_create) { ?>
                        <a href="<?php echo admin_url($url_path.'add'); ?>" class="btn btn-primary mright5">
                            ...
                            <?php echo _l('add_new', _l($lang_prefix.'state')); ?>
                        </a>
                    <?php } ?>
                </div>
                <div class="panel_s">
                            ...
                            <tbody>
                                <?php foreach ($states as $state) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo ls_get_country_name($state['country_id']); ?></td>
                                        <td><?php echo $state['name']; ?></td>
                                        <td>
                                            <a href="<?php echo admin_url($url_path.'edit/' . $state['id']); ?>" class="btn btn-default btn-icon">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo admin_url($url_path.'delete/' . $state['id']); ?>" class="btn btn-danger btn-icon _delete">
